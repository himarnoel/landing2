...
export default function Page() {
  return (
    <>
      ...
      <div className="flex items-center justify-between px-spacing-small md:px-spacing-normal mt-20">
        <div className="flex  flex-col gap-10  max-w-[800px] w-full">
          <div className=" z-10 gap-4 flex flex-col">
            ...
            <p className="z-50 md:text-2xl text-justify md:text-left w-4/5 font-medium">
          ...
          <div className=" z-10 gap-4 flex flex-col">
            <span className="text-green-normal font-medium text-xl md:text-4xl">
              What's Next?
            </span>
        ...
        <img
          src={thankHeroImage}
          className="h-full md:w-[82rem] lg:w-[40rem]  xl:w-[45rem] -z-10 object-contain absolute right-[10%] mt-10"
        />
      </div>

      <section
        id="overviews"
        className="w-full flex flex-col gap- my-20 items-center justify-center px-spacing-small md:px-spacing-normal p-4 rounded-xl relative  h-[24rem] before:md:max-h-max before:h-[30rem] before:rounded-full before:block before:absolute before:left-0 before:mt-[18rem] before:-ml-64 before:-translate-x-1/2 before:md:translate-x-0 before:-translate-y-20 before:aspect-square before:bg-red-500 before:-z-10 "
      >
        <div className="w-full relative rounded-[2em] px-10 bg-white shadow-md gap-10 xl:gap-2 lex flex-col items-center py-10 p-4">
          <header className="w-full flex flex-col items-center">
            ...
            <h3 className="text-center text-xl md:text-3xl text-blue-normal">
          ...
          <img
            src={microscopeIcon}
            alt=""
            className="h-20 absolute right-[15%] top-4"
          />
        </div>{" "}
      </section>
      ...
      <section className="w-full flex gap-10 flex-col py-10 pl-spacing-normal px-spacing-small md:pl-spacing-x-large md:px-spacing-normal">
        <h2 className="text-3xl md:text-6xl font-medium capitalize">
          stay tuned!
        </h2>
