  ...
  return (
    <>
      <div className="flex">
       ...
       <div className=" right-0 xl:right-10 md:absolute bottom-0 xl:-bottom-32 lg:mt-20  xl:64  -z-0 flex-1 md:flex-none basis-60 flex items-end justify-center">
        {/* <div className="h-4/5 aspect-[4/6] absolute rounded-[4em] -z-10 bg-pink-normal"/> */}
        <img
          src={thankHeroImage}
          className="h-full md:w-[82rem] lg:w-[40rem] xl:w-[45rem] z-10 object-contain"
        />
      </div>
      ...
      <Overview>
        <div className="w-full relative rounded-[2em] bg-white shadow-md gap-10 flex flex-col items-center py-10 p-4">
          <header className="w-full flex flex-col items-center">
            <h2 className="text-center text-xl md:text-4xl text-blue-normal">
          ...
          <img
            src={microscopeIcon}
            alt=""
            className="h-20 absolute right-1/4 top-4"
          />
        </div>
      </Overview>
      ...
      <section className="w-full flex gap-10 flex-col py-10 pl-spacing-normal px-spacing-small md:pl-spacing-x-large md:px-spacing-normal">
        <h2 className="text-3xl md:text-6xl font-bold capitalize">
          stay tuned
        </h2>
        <div className="w-full flex flex-col text-lg md:text-2xl gap-4 text-justify md:text-left">
          ...
          <p className="">
            Get ready to empower your students, ignite curiosity, and bring
            learning to life—the future of your classroom starts now!
          </p>
        </div>
      </section>
    </>
